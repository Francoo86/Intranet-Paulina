 ...
 */
final class Version20240103154000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE broadcaster (id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone INT NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, rut INT DEFAULT NULL, dv VARCHAR(1) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN broadcaster.deleted_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE customer (id INT NOT NULL, name VARCHAR(255) NOT NULL, organisation VARCHAR(255) DEFAULT NULL, phone INT NOT NULL, email VARCHAR(255) NOT NULL, rut INT NOT NULL, dv VARCHAR(1) NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN customer.deleted_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE guideline (id INT NOT NULL, broadcaster_id INT DEFAULT NULL, manager_id INT DEFAULT NULL, show_name VARCHAR(255) NOT NULL, emission_number INT NOT NULL, creation_date DATE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN guideline.deleted_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE manager (id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone INT NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE publicity (id INT NOT NULL, stock_id INT DEFAULT NULL, customer_id INT DEFAULT NULL, guideline_id INT DEFAULT NULL, audience_id INT DEFAULT NULL, show_id INT DEFAULT NULL, sentence TEXT NOT NULL, background VARCHAR(255) DEFAULT NULL, duration INT NOT NULL, description TEXT DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_9381276848CC616 ON publicity (audience_id)');
        $this->addSql('CREATE INDEX IDX_9381276D0C1FC64 ON publicity (show_id)');
        $this->addSql('COMMENT ON COLUMN publicity.deleted_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE report (id INT NOT NULL, manager_id INT DEFAULT NULL, creation_date DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C42F7784783E3463 ON report (manager_id)');
        $this->addSql('CREATE TABLE show (id INT NOT NULL, guideline_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, start TIME(0) WITHOUT TIME ZONE NOT NULL, finish TIME(0) WITHOUT TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_320ED901CC0B46A8 ON show (guideline_id)');
        $this->addSql('COMMENT ON COLUMN show.deleted_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, manager_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON "user" (email)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649783E3463 ON "user" (manager_id)');
        ...
        $this->addSql('ALTER TABLE "user" ADD CONSTRAINT FK_8D93D649783E3463 FOREIGN KEY (manager_id) REFERENCES manager (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
