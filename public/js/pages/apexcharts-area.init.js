...
var timelinechart = {
  ...
  colors: (chartBarColors = getChartColorsArray("area_chart_datetime")),
  annotations: {
    yaxis: [
      {
        y: 30,
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("area_chart_negative")),
  yaxis: {
    tickAmount: 4,
    floating: !1,
...
(chartBarColors = getChartColorsArray("area_chart-months")),
  (options = {
...
var generateDayWiseTimeSeries = function (e, t, a) {
  ...
  chartBarColors = getChartColorsArray("area_chart_stacked"),
  options = {
    series: [
      {
        name: "South",
...
(chartBarColors = getChartColorsArray("area_chart_irregular")),
  (options = {
    series: [
...
options = {
  ...
  colors: (chartBarColors = getChartColorsArray("area-missing-null-value")),
};
(chart = new ApexCharts(
